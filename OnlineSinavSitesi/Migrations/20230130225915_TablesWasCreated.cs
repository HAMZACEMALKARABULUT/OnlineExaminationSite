...
{
    public partial class TablesWasCreated : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ExamUsers", x => new { x.UId, x.EId });
                    table.ForeignKey(
                        name: "FK_ExamUsers_Exams_EId",
                        column: x => x.EId,
                        principalTable: "Exams",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ExamUsers_Users_UId",
                        column: x => x.UId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
                });
            //devamını sonra bakalım , şuan siteye giremiyoruz emme
